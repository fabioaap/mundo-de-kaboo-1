...
// Default = loja da Kaboo (Empatia Editora).
export const VOUCHER_UPSELL_STORE_URL = 'https://empatiaeditora.com.br/';
...
const VOUCHER_UPSELL_STORE_URL_BY_BRAND: Record<string, string> = {
  kaboo: 'https://empatiaeditora.com.br/',            // Empatia Editora (loja da Kaboo)
  'central-coruja': 'https://loja.educabox.com.br/',  // Universo Educacross (loja da Central Coruja)
};
