...
(async () => {
    ...
    try {
        ...
        await page.goto('https://www.youtube.com/@YouTube/videos', { waitUntil: 'networkidle' });
        
        const data = await page.evaluate(() => {
            const card = document.querySelector('ytd-rich-item-renderer, ytd-grid-video-renderer');
            if (!card) return { error: 'No grid card' };
