...
export const FileUpload: React.FC<FileUploadProps> = ({
  ...
  const handleRemove = async () => {
    ...
    if (folder === 'covers') {
      onChange('/assets/images/image-placeholder.png');
    } else {
      onChange('');
    }
    setError(null);
          ...
          <div className="mb-3">
            <div 
              ...
              onClick={() => {
                ...
                if (!value.includes('image-placeholder.png')) {
                  setShowPreview(true);
                }
              }}
            >
              <img
                ...
                onError={(e) => {
                  ...
                  (e.target as HTMLImageElement).src = '/assets/images/image-placeholder.png';
                }}
              />
              {/* Hover Overlay with Eye Icon - Only show if not placeholder */}
              {isHovering && !value.includes('image-placeholder.png') && (
            ...
            {value.includes('image-placeholder.png') ? (
              <button
                type="button"
                onClick={(e) => {
                  e.preventDefault();
