            ...
            >
              {filteredCollections.map((collection) => (
                <div 
                  ...
                  className="bg-white rounded-xl p-3 shadow-md shadow-gray-100 border border-gray-50 cursor-pointer active:scale-95 transition-transform hover:shadow-xl hover:-translate-y-1 hover:border-kaboo-primary/20"
                >
                  <div 
                     className="aspect-square mb-3 rounded-lg overflow-hidden relative group"
                     style={{ WebkitMaskImage: '-webkit-radial-gradient(white, black)' }}
                  >
                    <img src={collection.cover_image} alt={collection.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110 bg-gray-200" />
