    ...
    <div className="flex flex-col md:flex-row bg-white relative h-full w-full">
      ...
      <div className="relative md:w-1/3 h-64 md:h-full md:shrink-0 flex-shrink-0">
          ...
          <div className="relative h-full flex flex-col items-center justify-center px-6 py-6 z-30">
            <div className="w-48 h-48 md:w-64 md:h-64 rounded-3xl shadow-2xl mb-6 md:mb-0 relative group border-4 border-white/20 overflow-hidden shrink-0">
              <img 
      ...
      <div className="flex-1 overflow-y-auto z-10 no-scrollbar bg-white rounded-t-[2.5rem] md:rounded-none -mt-12 md:mt-0 relative shadow-[0_-10px_40px_rgba(0,0,0,0.05)] md:shadow-none md:h-full">
