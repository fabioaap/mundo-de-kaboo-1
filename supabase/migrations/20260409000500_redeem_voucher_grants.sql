-- ============================================================
-- Migration: Evolui redeem_voucher para criar user_content_grants
-- Quando o voucher está vinculado a um modelo (via batch), o resgate
-- insere grants de conteúdo para o usuário baseado no snapshot do lote.
-- ============================================================
